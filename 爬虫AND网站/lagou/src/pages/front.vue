<template>
  <div>
      ...
      <div id="graphTwo" width="800" height="800" style="width:800px;height:1500px" class="graph"></div>
...
secondoption = {
    ...
    this.$http.get("china").then((res) => {
        ...
        that.$http.get("front").then(res => {
          ...
          myTwoChart.on('click', function (params) {
          console.log(params)
          //that.$router.push({name:'Person',query:{person:params.data.}})
